        ...
        
    {
      ...
      Cell: (row) => {
        ...
        const handleDelete = async () => {
          try {
            await axios.get(`http://localhost:3000/api/v1/superdesign/delete/${row.row.original.id}`);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get('http://localhost:3000/api/v1/superdesign');
